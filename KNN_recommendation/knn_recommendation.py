...
class KnnRecommender:
    ...
    def _prep_data(self):
        ...
        df_movies = pd.read_csv(
            'data/eventcd_data.csv',
            dtype={'movieId': 'int32', 'title': 'str'})
        df_ratings = pd.read_csv(
            'data/interaction_data1.csv',
...
def parse_args():
    ...
    parser.add_argument('--movies_filename', nargs='?', default='eventcd_data.csv',
                        help='provide movies filename')
    parser.add_argument('--ratings_filename', nargs='?', default='interaction_data1.csv',
...
if __name__ == '__main__':
    ...
    # set params
    recommender.set_filter_params(50, 1)
