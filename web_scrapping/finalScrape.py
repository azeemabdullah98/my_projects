...
def ProductScrape(links): 
    ...
    product_bucket=s3.Bucket('products.csv.file')
    product_bucket.upload_file(Filename='output.csv',Key='productScrapeFile.csv')
    error_bucket=s3.Bucket('error.links')
    error_bucket.upload_file(Filename='links.txt',Key='url_links.txt')